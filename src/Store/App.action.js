export class AppAction {
  ...
  static SAVE_USER_TOUR = {
    SAVING: "SAVING USER TOUR",
    SAVED: "USER TOUR SAVED SUCCESSFULLY",
    FAILURE: "ERROR IN SAVING USER TOUR",
  };

  static FETCH_TOURS = {
    LOADING: "LOADING TOURS",
    LOADED: "LOADED TOURS",
    FAILURE: "FAILED TO LOAD TOURS",
  };

  static FETCH_TOUR_DETAILS = {
    LOADING: "LOADING TOUR DETAILS",
    LOADED: "LOADED TOUR DETAILS",
    FAILURE: "FAILED TO LOAD TOUR DETAILS",
  };

  static SELECT_ADDRESS = "SELECT UNSELECT ADDRESS";
